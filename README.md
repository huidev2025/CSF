...
│   └── 体验对比指南.md
├── csf-lite/                     # 实战级框架（引擎 + 三元组 + 协议库 + 经验库）
│   ├── cos-context.md            # 参谋长引擎
│   ├── core/                     # 身份内核与规范
│   ├── triplets/                 # 三元组文件
│   ├── protocols/                # 操作规程
│   └── knowledge/                # 经验库
├── csf-lite-doc/                 # CSF Lite 使用文档
│   ├── 安装与配置.md              # 图文安装指南
│   └── Clarity-使用手册.md        # Clarity 桌面工具手册
├── clarity-dev/                  # Clarity 桌面程序源码（PyQt6，可选辅助工具）
├── csf-clarity/                  # Clarity 运行数据目录（提示词/段库/备份）
└── RELEASE.md                    # 发布说明 + 自举包使用指引
```
...
| **[csf-lite](csf-lite/README.md)** | 个人 / 小团队，真实项目落地。拷贝即用，AI 自举管理。 |
...
- [x] csf-lite 公开介绍（[csf-lite/README.md](csf-lite/README.md)）
- [ ] 实践案例与社区反馈
